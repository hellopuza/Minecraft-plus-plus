...
char* RayTracer::writeShader()
{
    ...
    sprintf(str_shader,
        ...
        "            crossing.point = RayPoint(crossing.ray, dot((crossing.side_centre - crossing.ray.origin), crossing.normal) / dot_product) + crossing.ray.direction * 8e-6;\n"
